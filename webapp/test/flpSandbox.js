		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "www.anubhavtrainings.com",
									"targetURL": "#marabzordmar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"marabzordmar-display": {
								"semanticObject": "marabzordmar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mar.ab.zordmar",
									"url": sap.ui.require.toUrl("mar/ab/zordmar")
								}
							}
						}
					}
